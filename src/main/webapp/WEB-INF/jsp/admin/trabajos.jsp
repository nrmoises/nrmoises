...
<main class="main">
    ...
    <div class="content">
        ...
        <p class="trabajos-subtitle">
            Gestiona las actividades y documentos registrados
            durante las semanas académicas.
        </p>
        ...
        <section class="panel tablewrap trabajos-panel">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="trabajo-info">
                                ...
                                <strong class="trabajo-titulo">
                                    ${x.titulo}
                                </strong>

                                <span class="trabajo-sub">
                                    DOCUMENTO ACADÉMICO
                                </span>
                        ...
                        <td>
                            ...
                            <span class="tipo-badge">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${x.tipoArchivo eq 'application/pdf'}">
                                        PDF
                                    </c:when>

                                    <c:when test="${x.tipoArchivo eq 'image/png'}">
                                        PNG
                                    </c:when>

                                    <c:when test="${x.tipoArchivo eq 'image/jpeg'}">
                                        JPG
                                    </c:when>

                                    <c:when test="${x.tipoArchivo eq 'application/msword'}">
                                        WORD
                                    </c:when>

                                    <c:when test="${x.tipoArchivo eq 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'}">
                                        WORD
                                    </c:when>
                        ...
                        <td>
                            ...
                            <div class="actions">
                                ...
                                <button
                                    ...
                                    data-url="${pageContext.request.contextPath}/admin/trabajos/eliminar/${x.id}"
                                    data-title="${x.titulo}"
                                >
                                    Eliminar
                                </button>
...
<style>
    ...
    .trabajos-table tbody td:first-child {
        border-left:
            1px solid rgba(255, 255, 255, .06);
    ...
    .trabajos-table tbody td:last-child {
        border-right:
            1px solid rgba(255, 255, 255, .06);
